Feature: Vehicle Charging
  ...
  Scenario: Successful charging session
    When customer "Alice" starts charging at charger "Charger-1" for 20 minutes
    Then the charging session for customer "Alice" at charger "Charger-1" is completed
  ...
  Scenario: Charger becomes occupied during charging
    When customer "Alice" starts charging at charger "Charger-1" for 10 minutes
  ...
  Scenario: Error – customer has insufficient balance
    ...
    When customer "Bob" starts charging at charger "Charger-1" for 60 minutes
